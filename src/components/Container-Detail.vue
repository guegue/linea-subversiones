    ...
    <div id="Content">
        <div class="content_wrapper clearfix">
            <div class="sections_group">
                <div id="post-2275" class="no-title no-share post-2275 post  format-standard has-post-thumbnail  category-earth  tag-grid ">
                    <div class="section section-post-header">
                        <div class="section_wrapper clearfix">
                            <!-- Posts Navigation -->
                            <!-- One full width row-->
                            <div class="column one post-nav">
                                <a class="fixed-nav fixed-nav-prev " href="item-3.html"><span class="arrow"><i class="icon-left-open-big"></i></span>
                                    <div class="photo"><img width="80" height="80" src="images/home_space_blog1-80x80.jpg" class="attachment-blog-navi wp-post-image" alt="home_space_blog1" />
                                    </div>
                                    <div class="desc">
                                ...
                                <ul class="next-prev-nav">
                                    <li class="prev">
                                        <a class="button button_js" href="item-3.html"><span class="button_icon"><i class="icon-left-open"></i></span></a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="post-meta clearfix">
                                        <div class="author-date">
                                            <span class="vcard author post-author"> Published by <i class="icon-user"></i> <span class="fn"><a href="#">admin</a></span> </span><span class="date"> at <i class="icon-clock"></i>
														<time class="entry-date" datetime="2014-05-09T09:28:12+00:00" itemprop="datePublished" pubdate>
															May 9, 2014
														</time> </span>
                                        </div>
                                ...
                                <div class="image_frame scale-with-grid ">
                                    <div class="image_wrapper">
                                        <a href="images/home_space_blog3-1200x800.jpg" rel="prettyphoto">
                                            <div class="mask"></div><img width="1200" height="480" src="images/home_space_blog3-1200x480.jpg" class="scale-with-grid wp-post-image" alt="home_space_blog3" />
                                        </a>
                                        <div class="image_links">
                                            <a href="images/home_space_blog3-1200x800.jpg" class="zoom" rel="prettyphoto"><i class="icon-search"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="column one author-box">
                                    <div class="author-box-wrapper">
                                        <div class="avatar-wrapper">
                                            <img alt='admin' src='http://0.gravatar.com/avatar/057e2eb392b95a2ecfc9d32d554e3917?s=64&amp;d=mm&amp;r=g'   class='avatar avatar-64 photo' height='64' width='64' />
                                        </div>
                ...
                <div class="widget-area clearfix m-2">
                    ...
                    <aside class="widget widget_text">
                        ...
                        <div class="textwidget">
                            Mauris imperdiet, urna mi, gravida sod ales. Vivamus hendrerit nulla erat ornare tortor in vestibulum id.
                        </div>
                    </aside>
                    <!-- Categories Area -->
