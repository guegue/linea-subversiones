    ...
    <div class="content_wrapper clearfix">
      <div class="sections_group">
        <div class="entry-content">
          <div
            class="section full-screen full-width highlight-right section-border-bottom"
            style="padding-top: 0"
          >
            ...
            <div class="section_wrapper clearfix">
              <div class="items_group clearfix">
                ...
                <div class="column one-second column_column space-border">
                  <div
                    v-for="(contribuitor, index) in constribuitors"
                    :key="index"
                  ...
                  >
                    ...
                    <ul class="list_check" style="font-size: 13px">
                      <li
                        v-for="(person, index) in contribuitor.list"
                        :key="index"
                        class="icons-list"
                      >
                        {{ person }}
          ...
          <div
            ...
            class="section"
            style="padding-top: 90px; padding-bottom: 50px"
          >
            <div class="section_wrapper clearfix">
              <div class="items_group clearfix">
                ...
                <div class="column one-fourth column_column">
                  <div class="column_attr p-8">
                    ...
                    <a
                      ...
                      :href="urlVideos"
                      ><span class="button_label">Ver m&aacute;s</span></a
                    >
                  </div>
                </div>
          ...
          <!--Sites Details-->
          <div
            class="section no-margin equal-height background-document"
            style=""
          >
            <div class="section_wrapper clearfix">
              <div class="items_group clearfix">
                  ...
                  <div class="column_attr">
                    <div class="img-background-document">
                      ...
                      <scrolly class="foo" style="width: 100%; height: 100%">
                        <scrolly-viewport>
                          <div
                            v-for="(site, index) in detailsSite"
                            :key="index * 9"
                          >
                ...
                <div class="column one-second column_column">
                  <div class="column_attr p-6-4-7 text-white">
                    ...
                    <h5 v-if="contact.description !== ''" class="text-white">
                      {{ contact.description }}
                    </h5>
                    <hr class="no_line hrmargin_b_30" />
