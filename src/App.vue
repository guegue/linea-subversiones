<template>
    <div id="app">
        ...
        <!--         Main Theme Wrapper -->
        <!--<div id="Wrapper">-->
            <!--&lt;!&ndash;               Header Wrapper &ndash;&gt;-->
            <!--<div id="Header_wrapper">-->
                <!--&lt;!&ndash;                 Header&ndash;&gt;-->
                <!--<header id="Header">-->

                    <!--&lt;!&ndash;                     Header -  Logo and Menu area &ndash;&gt;-->
                    <!--<div id="Top_bar">-->
                        <!--<div class="container">-->
                            <!--<div class="column one">-->
                                <!--<div class="top_bar_left clearfix">-->
                                    ...
                                    <!--</div>-->
                                    <!--&lt;!&ndash;Secondary menu area - only for certain pages &ndash;&gt;-->
                                    <!--<div class="secondary_menu_wrapper"></div>-->
                                    <!--&lt;!&ndash;Banner area - only for certain pages&ndash;&gt;-->
                                    <!--<div class="banner_wrapper"></div>-->
                                    <!--&lt;!&ndash;Header Searchform area&ndash;&gt;-->
                    ...
                    <!--<div class="sections_group">-->
                        <!--<div class="entry-content">-->
                            <!--<div class="section full-screen full-width highlight-right section-border-bottom img-background"-->
                                 <!--style="padding-top:0; padding-bottom:0;background-size:cover; -webkit-background-size:cover"-->
                                                        ...
                                                        <!--<ul>-->
                                                            <!--<li data-index="rs-2279" data-transition="parallaxvertical"-->
                                                                ...
                                                                <!--<div class="tp-caption Newspaper-Title tp-resizeme rs-parallaxlevel-0"-->
                                                                     ...
                                                                     <!--data-responsive_offset="on"-->
                                                                     <!--style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal; font-weight: 700;">-->
                                                                    <!--Quisque lorem tortor fringilla&ndash;&gt;-->
                                                                <!--</div>-->
                                                                <!--<div class="tp-caption Newspaper-Subtitle tp-resizeme rs-parallaxlevel-0"-->
                                                                     <!--id="slide-2279-layer-2"-->
                                                                     <!--data-x="['left','left','left','left']"-->
                                                                     <!--data-hoffset="['50','50','50','30']"-->
                                                                     <!--data-y="['top','top','top','top']"-->
                                                                     <!--data-voffset="['140','110','80','100']"-->
                                                                     <!--data-fontweight="['400','900','900','900']"-->
                                                                     <!--data-color="['rgba(255, 255, 255, 1.00)','rgba(168, 216, 238, 1.00)','rgba(168, 216, 238, 1.00)','rgba(168, 216, 238, 1.00)']"-->
                                                                     ...
                                                                     <!--data-splitin="none" data-splitout="none"-->
                                                                     <!--data-responsive_offset="on"-->
                                                                     <!--style="z-index: 7; white-space: nowrap; font-weight: 400; color: rgba(255, 255, 255, 1.00);text-transform:uppercase;">-->
                                                                    <!--May 6, 2014-->
                                                                <!--</div>-->
                                                                <!--<a class="tp-caption Newspaper-Button rev-btn rs-parallaxlevel-0"-->
                                                                   <!--href="content/space/item-1.html" target="_self"-->
                                                                   <!--id="slide-2279-layer-5"-->
                                                                   <!--data-x="['left','left','left','left']"-->
                                                                   ...
                                                                   <!--style="z-index: 8; white-space: nowrap;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">Read-->
                                                                    <!--more </a>-->
                                                            <!--</li>-->
                                                            <!--<li data-index="rs-2281" data-transition="parallaxvertical"-->
                                                                <!--data-slotamount="default" data-easein="default"-->
                                                                <!--data-easeout="default" data-masterspeed="default"-->
                                                                <!--data-thumb="content/space/images/home_space_blog4-100x50.jpg"-->
                                                                ...
                                                                <!--</div>-->
                                                                <!--<a class="tp-caption Newspaper-Button rev-btn rs-parallaxlevel-0"-->
                                                                   <!--href="content/space/item-4.html" target="_self"-->
                                                                   <!--id="slide-2281-layer-5"-->
                                                                   <!--data-x="['left','left','left','left']"-->
                                                                   <!--data-hoffset="['53','53','53','30']"-->
                                                                   <!--data-y="['top','top','top','top']"-->
                                                                   <!--data-voffset="['361','331','301','245']"-->
                                                                   ...
                                                                   <!--style="z-index: 8; white-space: nowrap;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">Read-->
                                                                    <!--more </a>-->
                                                            <!--</li>-->
                                                            <!--<li data-index="rs-2277" data-transition="parallaxvertical"-->
                                                                <!--data-slotamount="default" data-easein="default"-->
                                                                <!--data-easeout="default" data-masterspeed="default"-->
                                                                <!--data-thumb="content/space/images/home_space_blog1-100x50.jpg"-->
                                                                <!--data-rotate="0" data-saveperformance="off"-->
                                                                ...
                                                                <!--</div>-->
                                                                <!--<a class="tp-caption Newspaper-Button rev-btn rs-parallaxlevel-0"-->
                                                                   <!--href="content/space/item-3.html" target="_self"-->
                                                                   <!--id="slide-2277-layer-5"-->
                                                                   <!--data-x="['left','left','left','left']"-->
                                                                   <!--data-hoffset="['53','53','53','30']"-->
                                                                   <!--data-y="['top','top','top','top']"-->
                                                                   <!--data-voffset="['361','331','301','245']"-->
                                                            ...
                                                            <!--<li data-index="rs-2275" data-transition="parallaxvertical"-->
                                                                ...
                                                                <!--</div>-->
                                                                <!--<a class="tp-caption Newspaper-Button rev-btn rs-parallaxlevel-0"-->
                                                                   <!--href="content/space/item-2.html" target="_self"-->
                                                                   <!--id="slide-2275-layer-5"-->
                                                                   <!--data-x="['left','left','left','left']"-->
                                                                   <!--data-hoffset="['53','53','53','30']"-->
                                                                   <!--data-y="['top','top','top','top']"-->
                                                                   <!--data-voffset="['361','331','301','245']"-->
                ...
                <!--<div class="widgets_wrapper">-->
                    <!--<div class="container">-->
                        ...
                        <!--<div class="column one-fourth">-->
                            <!--&lt;!&ndash;Meta Links Area &ndash;&gt;-->
                            <!--<aside id="meta-2" class="widget widget_meta">-->
                                <!--<h4>Useful links</h4>-->
                                <!--<ul>-->
                                    <!--<li>-->
                                        <!--<a href="content/space/wp-login.html">Log in</a>-->
                                    <!--</li>-->
                                    <!--<li>-->
                        ...
                        <!--&lt;!&ndash;One Fourth (1/4) Column &ndash;&gt;-->
                        <!--<div class="column one-fourth">-->
                            <!--&lt;!&ndash;Recent Comments Area &ndash;&gt;-->
                            <!--<aside class="widget widget_mfn_recent_comments">-->
                                <!--<h4>Latest comments</h4>-->
                                <!--<div class="Recent_comments">-->
                                    <!--<ul>-->
                                        <!--<li>-->
                                            <!--<span class="date_label">December 31, 2014</span>-->
                                            <!--<p>-->
                                                <!--<i class="icon-user"></i><strong>Sara</strong> commented on <a-->
                                                    <!--href="content/space/item-2.html#comment-3"-->
                                                    <!--title="Sara | Vestibulum ante ipsum primis">Vestibulum ante ipsum-->
                                                <!--primis</a>-->
                                            <!--</p>-->
                                        <!--</li>-->
                                        <!--<li>-->
                                            <!--<span class="date_label">December 31, 2014</span>-->
                                            <!--<p>-->
                                                <!--<i class="icon-user"></i><strong>Mark</strong> commented on <a-->
                                                    <!--href="content/space/item-2.html#comment-2"-->
                                                    <!--title="Mark | Vestibulum ante ipsum primis">Vestibulum ante ipsum-->
                                                <!--primis</a>-->
                                            <!--</p>-->
                                        <!--</li>-->
                                    <!--</ul>-->
                        ...
                        <!--<div class="column one-fourth">-->
                            ...
                            <!--<aside class="widget widget_text">-->
                                ...
                                <!--<div class="textwidget">-->
                                    <!--<h6 style="color: #97A1AD;">Interdum nulla lectus vel justo. Curabitur fringilla-->
                                        <!--nisi a ex.</h6>-->
                                    <!--<p>-->
                        ...
                        <!--&lt;!&ndash; One Fourth (1/4) Column &ndash;&gt;-->
                        <!--<div class="column one-fourth">-->
                            <!--&lt;!&ndash;Tag Cloud &ndash;&gt;-->
                            <!--<aside class="widget widget_tag_cloud">-->
                                <!--<h4>Tags</h4>-->
                                <!--<div class="tagcloud">-->
                                    <!--<a href="" class='tag-link-4' title='1 topic'-->
                                       <!--style='font-size: 8pt;'>Framework</a><a href='content/space/tag-grid.html'-->
                                                                               <!--class='tag-link-5' title='1 topic'-->
                                                                               <!--style='font-size: 8pt;'>Grid</a><a-->
                                        <!--href='content/space/tag-motion.html' class='tag-link-9' title='1 topic'-->
                                        <!--style='font-size: 8pt;'>Motion</a><a href='content/space/tag-video.html'-->
                                                                             <!--class='tag-link-8' title='2 topics'-->
                                                                             <!--style='font-size: 22pt;'>Video</a><a-->
                                        <!--href='content/space/tag-wordpress.html' class='tag-link-7' title='2 topics'-->
                                        <!--style='font-size: 22pt;'>Wordpress</a>-->
                                <!--</div>-->
                            <!--</aside>-->
                        <!--</div>-->
                    <!--</div>-->
